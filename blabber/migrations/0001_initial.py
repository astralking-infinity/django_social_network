# Generated by Django 2.1 on 2018-08-24 19:10
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('text', models.TextField()),
                ('file_upload', models.FileField(blank=True, null=True, upload_to='post_file')),
        ...
        migrations.AddField(
            model_name='comment',
            name='commented_to',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='comments', to='blabber.Post'),
        ),
        migrations.AddField(
            model_name='comment',
            name='likes',
